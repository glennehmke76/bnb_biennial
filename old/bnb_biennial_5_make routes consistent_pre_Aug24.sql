...
DROP VIEW IF EXISTS provided_vs_consistent;
CREATE VIEW provided_vs_consistent AS
WITH
...
SELECT
  ...
  total_length_routes_provided.region_name,
...
;
--   ST_Difference(routes_provided.geom, buffered_routes_consistent.geom)
